...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <form class="" action="{{URL::to('/edit-slide-data')}}" method="post" enctype="multipart/form-data">
          @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Sửa slide</h5>
                    <?php
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="slide-name" value="{{$slide_ed->SlideName}}" name="SlideName" class="form-control" placeholder="Tên sản phẩm">
                    </div>

                    <div class="form-group mb-3">
                        <div class="fallback">
                          <label for="image">Hình ảnh 1<span class="text-danger"> : </span></label>
                            <img src="{{('Upload/Slide/'.$slide_ed->SlideImage.'')}}"  height="100">
                            <input  name="SlideImage"  value="{{$slide_ed->SlideImage}}" type="file" rows="3" id="image"/>
                        </div>
                    </div>

                    <div class="form-group mb-3">
                        <label for="Slide-summary">Tiêu đề</label>
                        <input type="text" class="form-control"  value="{{$slide_ed->SlideTitle}}" name="SlideContent" id="Slide-summary" rows="2" placeholder="Tóm tắt sản phẩm">
                    </div>

                    <div class="form-group mb-3">
                        <label for="Slide-description">Nội dung hiển thị<span class="text-danger">*</span></label>
                        <input type="text" class="form-control"  value="{{$slide_ed->SlideContent}}" name="SlideDes" id="Slide-description" rows="5" placeholder="Please enter description">
                    </div>
