...
<head>
	...
	<link href="{{asset('frontend/css/satabli.min.css')}}" rel="stylesheet">
	...
	<link href="{{asset('frontend/revolution/css/settings.css')}}" rel="stylesheet">
	<link href="{{asset('frontend/revolution/css/navigation.css')}}" rel="stylesheet">
	<link href="{{asset('frontend/revolution/custom-setting.css')}}" rel="stylesheet">
			...
			<div class="container wide">
				...
				<div class="header-bottom-container">
					...
					<div class="logo-with-offcanvas d-flex">
						...
						<div class="logo">
							<a href="index.html">
								<img src="{{('frontend/images/logo1.png')}}" style="width:50%" class="img-fluid" alt="">
							</a>
						</div>
...
@yield('content')
		...
		<div class="container wide">
			<div class="row">
				<div class="col footer-single-widget">
					...
					<div class="logo">
						<img src="{{('frontend/images/logo1.png')}}" class="img-fluid" alt="">
					</div>
						...
						<div class="single-cart-product">
							...
							<div class="image">
								<a href="shop-product-basic.html">
									<img src="{{URL::to('Upload/Product/'.$value->ProductImage.'')}}" class="img-fluid" alt="">
								</a>
							</div>
							<div class="content">
            ...
            $data_cart = Cart::content();
             ?>
						...
						<div class="single-cart-product">
							...
							<div class="image">
								<a href="shop-product-basic.html">
									<img src="{{('Upload/Product/'.$value->options->image.'')}}" class="img-fluid" alt="">
								</a>
							</div>
							<div class="content">
	...
	<div id="qv-{{$value->ProductID}}" class="cd-quick-view">
		<div class="cd-slider-wrapper">
			<ul class="cd-slider">
				<li class="selected"><img src="{{('Upload/Product/'.$value->ProductImage1.'')}}" alt="Product 2"></li>
				<li><img src="{{('Upload/Product/'.$value->ProductImage2.'')}}" alt="Product 1"></li>
			</ul> <!-- cd-slider -->
...
@endif
	...
	<script src="{{asset('frontend/revolution/revolution-active.js')}}"></script>
	...
	<script type="text/javascript" src="{{asset('frontend/js/sweetalert2.min.js')}}"></script>
